    ...
    <form action="{{ route('business-permits.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="osh-bg row m-0 mt-3 border">
            ...
            <div class="col col-6 p-1">
                ...
                <input type="text" id="set_emp" class="form-control" value="{{ $emp->e_fname }} {{ $emp->e_lname }}"
                    readonly disabled>
        ...
        <div class="osh-bg row m-0 mt-3">
            ...
            <div class="col col-12 my-2 text-center p-1">
                <h4 class="osh-outline text-center">Basic Personal Info:</h4>
            </div>
            ...
            <div class="col col-4 p-1">
                ...
                <input type="text" name="fname" class="form-control" value="{{ old('fname') }}"
                    placeholder="Ex. Juan">
                @error('fname')
                    <div class="mt-1 text-center" style="background-color: rgb(255, 100, 100); border-radius:10px;">
                        {{ $message }}</div>
                @enderror
            </div>
            <div class="col col-4 p-1">
            ...
            <div class="col col-6 p-1">
                ...
                <select name="address" id="address" class="form-select" onchange="getId()">
                    ...
                    @foreach ($address as $row)
                        <option value="{{ $row->mun_id }},{{ $row->brgy_id }}:{{ $row->subd_id }}">
                            {{ $row->mun_name }}, {{ $row->brgy_name }} - {{ $row->subd_name }}</option>
                    @endforeach
        ...
        <div class="osh-bg row m-0 mt-4 border justify-content-center">
            ...
            <div class="col col-12 my-2 text-center p-1">
                <h4 class="osh-outline text-center">Permits/Files/Certificates:</h4>
            </div>

            <div class="col col-6 p-1">
                <label for="bStructure">
            ...
            <div class="col col-6 p-1">
                <label for="dticdaCertFile">
                    <h5>DTI/CDA Certificate:</h5>
                </label>
                <input type="file" name="dticdaCertFile" id="dticdaCertFile" class="form-control" required
                    onchange="set_dticdaCertFile()">
            ...
            <div class="col col-6 p-1">
                <label for="busPermitFile">
                    <h5>Business/Mayor's Permit:</h5>
                </label>
                <input type="file" name="busPermitFile" id="busPermitFile" class="form-control" required
                    onchange="set_busPermitFile()">
            ...
            <div class="col col-6 p-1">
                <label for="brgyClearanceFile">
                    <h5>Brgy. Clearance:</h5>
                </label>
                <input type="file" name="brgyClearanceFile" id="brgyClearanceFile" class="form-control" required
                    onchange="set_brgyClearanceFile()">
            ...
            <div class="col col-6 p-1">
                <label for="ctcFile">
                    <h5>Community Tax Certificate "Cedula":</h5>
                </label>
                <input type="file" name="ctcFile" id="ctcFile" class="form-control" required
                    onchange="set_ctcFile()">
            ...
            <div class="col col-6 p-1">
                <label for="contOfLeaseFile">
                    <h5>Contract of Lease/Title of Land:</h5>
                </label>
                <input type="file" name="contOfLeaseFile" id="contOfLeaseFile" class="form-control" required
                    onchange="set_contOfLeaseFile()">
            ...
            <div class="col col-8 p-1">
                <label for="zoningClearanceFile">
                    <h5>Zoning Clearance:</h5>
                </label>
                <input type="file" name="zoningClearanceFile" id="zoningClearanceFile" class="form-control" required
                    onchange="set_zoningClearanceFile()">
        ...
        <div class="osh-bg row m-0 mt-4 border justify-content-center">
            ...
            <div class="col col-12 my-2 text-center">
                <h4 class="osh-outline text-center">Other Permits:</h4>
            </div>

            <div class="col col-6 p-1">
                <label for="sanitaryFile">
                    <h5>Sanitary Permit:</h5>
                </label>
                <input type="file" name="sanitaryFile" id="sanitaryFile" class="form-control"
                    onchange="set_sanitaryFile()">
                <input type="text" name="get_sanitaryFile" id="get_sanitaryFile" hidden>
            </div>
            <div class="col col-6 p-1">
                <label for="fireSafetyFile">
                    <h5>Fire Safety Permit:</h5>
                </label>
                <input type="file" name="fireSafetyFile" id="fireSafetyFile" class="form-control"
                    onchange="set_fireSafetyFile()">
        ...
        <div class="row mt-5">
            <div class="col col-6">
                <button type="submit" class="btn btn-success w-100 fs-5 fw-semibold">Submit</button>
            </div>
            <div class="col col-6">
                <a href="{{ route('business-permits.index') }}"
                    class="btn w-100 text-white bg-secondary fs-5 fw-semibold">Cancel</a>
            </div>
        </div>
