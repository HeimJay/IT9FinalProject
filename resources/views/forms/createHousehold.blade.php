                    ...
                    <div class="card-body" style="background-color: #C8E6C9;">
                        ...
                        <form action="{{ route('households.store') }}" method="post">
                            ...
                            <div class="osh-bg row border mt-5">
                                ...
                                <div class="col col-6 p-0 pe-1">
                                    <div class="osh-outline">
                                        <label for="htype" class="form-label">
                                            <h5>House Type</h5>
                                        </label>
                                        <input class="form-control" name="htype" id="htype"
                                        ...
                                        @error('htype')
                                            <div class="mt-1 text-center"
                                                style="background-color: rgb(255, 100, 100); border-radius:10px;">
                                                {{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                    ...
                                    <div class="osh-outline">
                                        ...
                                        <select name="address" id="address" class="form-select" onchange="getId()">
                                            ...
                                            @foreach ($address as $row)
                                                <option
                                                    value="{{ $row->mun_id }},{{ $row->brgy_id }}:{{ $row->subd_id }}">
                                                    {{ $row->mun_name }} - {{ $row->brgy_name }} - {{ $row->subd_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('address')
                            ...
                            <div class="osh-bg row mt-3">
                                ...
                                <div class="col col-3 mt-2">
                                    ...
                                    <input type="text" name="mname[]" id="mname" class="form-control"
                                        placeholder="Ex. Martinez"required>
                                </div>
                                <div class="col col-3 mt-2">
                                    <label for="lname">
                                        <h5>Last Name:</h5>
                                ...
                                <div class="col col-2 mt-2">
                                    ...
                                    <input type="text" name="religion[]" id="religion" class="form-control"
                                        placeholder="Ex. Roman Catholic" required>
                                </div>
                                <div class="col col-2 mt-2">
                                    <label for="frole">
                                        <h5>Family Role:</h5>
                                ...
                                <div class="col col-2 mt-2">
                                    ...
                                    <input type="text" name="yrsOfResidency[]" id="yrsOfResidency"
                                        class="form-control" required>
                                </div>
                                <div class="col col-3 mt-2">
                                    <label for="birth">
                                ...
                                <div class="col col-3 mt-2">
                                    ...
                                    <input type="text" name="educAttainment[]" id="educAttainment"
                                        class="form-control" required>
                                </div>
                                ...
                                <div class="col col-4 mt-2">
                                    ...
                                    <input type="text" name="empStatus[]" id="empStatus" class="form-control"
                                        required>
                                </div>
                                <div class="col col-4 mt-2">
                                    <label for="income">
                            ...
                            <div class="row justify-content-end mt-3">
                                <div class="col col-2">
                                    <a href="javascript:void(0)"
                                        class="add-more-form float-end btn btn-success w-100 fs-5 fw-semibold">Add
                                        More</a>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col col-6">
                                    <button type="submit"
                                        class="btn btn-success w-100 fs-5 fw-semibold">Submit</button>
                                </div>
                                <div class="col col-6">
                                    <a href="{{ route('households.index') }}"
                                        class="btn btn-light w-100 fs-5 fw-semibold">Cancel</a>
                                </div>
                            </div>
