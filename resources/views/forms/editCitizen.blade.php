    ...
    <form action="{{ route('citizens.update', $citData->id) }}" method="post" class="m-0">
        ...
        <div class="row mt-3">
            ...
            <div class="col col-2 mt-2">
                ...
                <input type="text" name="frole" id="frole" class="form-control" list="frolelist"
                    value="{{ $citData->family_role }}">
            ...
            <div class="col col-2 mt-2">
                ...
                <input type="text" name="yrsOfResidency" id="yrsOfResidency" class="form-control"
                    value="{{ $citData->years_of_residency }}">
            ...
            <div class="col col-3 mt-2">
                ...
                <input type="text" name="educAttainment" id="educAttainment" class="form-control"
                    value="{{ $citData->educational_attainment }}">
            ...
            <div class="col col-4 mt-2">
                ...
                <input type="text" name="empStatus" id="empStatus" class="form-control"
                    value="{{ $citData->employment_status }}">
                @error('empStatus')
                    <div class="mt-1 text-center" style="background-color: rgb(255, 100, 100); border-radius:10px;">
                        {{ $message }}</div>
                @enderror
        ...
        <div class="row mt-5">
            <div class="col col-6">
                <button type="submit" class="btn btn-success w-100 fs-5 fw-medium">Update</button>
            </div>
            <div class="col col-6">
                <a href="{{ route('households.show', $citData->household_id) }}"
                    class="btn w-100 text-white fs-5 fw-medium bg-secondary">Cancel</a>
            </div>
        </div>
    </form>
