    ...
    <div class="col col-2">
        <div class="floating-box osh-bg">
            ...
            <div class="osh-outline">
                <button type="button" class="btn w-100 text-white bg-success fs-5 fw-medium" data-bs-toggle="modal"
                    data-bs-target="#addCitizenModal">
                    Add Citizen
                </button>

                <button type="button" class="btn w-100 text-white mt-3 bg-success fs-5 fw-medium" data-bs-toggle="modal"
                    data-bs-target="#editHouseholdModal">
                    Edit Household
                </button>

                <!-- Button trigger modal -->
                <button type="button" class="btn w-100 text-white mt-3 bg-danger fs-5 fw-medium" data-bs-toggle="modal"
            ...
            <div class="osh-outline mt-5">
                <div class="row">
                    <div class="col text-center">
                        <a href="{{ route('households.index') }}" class="btn w-100 text-white bg-secondary fs-5 fw-medium">
                            Go Back
                        </a>
                    </div>
                </div>
...
@section('view-content')
    ...
    <div class="osh-bg">
        ...
        <h4 class="osh-outline">Address: {{ $house->HHoldToMun->mun_name }}, {{ $house->HHoldToBrgy->brgy_name }}
            {{ $house->HHoldToSubd->subd_name }}</h4>
        <h4 class="osh-outline">Family Income: ₱ {{ $getCitizen->sum('income') }}</h4>

        @session('message')
            <div class="bg-info rounded-3 mt-2 p-2" style="text-align: center;">
                <h5>{{ $value }}</h5>
            </div>
        @endsession
                ...
                <div class="col col-5 align-self-center">
                    ...
                    <div class="osh-outline row">
                        ...
                        <div class="col col-12 p-0">
                            <h4>Name: </h4>
                            <h5 style="border-bottom: solid 2px black;">{{ $row->lname }}, {{ $row->fname }}
                                {{ $row->mname }}</h5>
                        </div>
                        <div class="col col-12 p-0">
                            <h4>Suffix: </h4>
                    ...
                    <div class="osh-outline row">
                        ...
                        <div class="col col-12 p-0 ">
                            <div class="row mt-4 mb-2">
                                <div class="col col-6">
                                    <a href="{{ route('citizens.edit', $row->id) }}"
                                        class="btn w-100 text-white bg-success fs-6 fw-medium">Edit</a>
                                </div>
                                <div class="col col-6">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn w-100 text-white fs-6 fw-medium"
                                    ...
                                    <!-- Delete Modal -->
                                    <div class="modal fade" id="deleteModal{{ $row->id }}" data-bs-backdrop="static"
                                        data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="deleteModal{{ $row->id }}Label" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="deleteModal{{ $row->id }}Label">
                                                ...
                                                <form action="{{ route('citizens.destroy', $row->id) }}" method="post"
                                                    class="m-0">
                                                    @csrf
                                                    @method('delete')

                                                    <div class="modal-body">
                                                        <h4>Are you sure you want to <strong>DELETE</strong>
                                                            {{ $row->lname }}, {{ $row->fname }} {{ $row->mname }}
                                                            citizen?</h4>
                                                    </div>
                                                    <div class="modal-footer">

                                                        <button type="submit" class="btn text-white fs-5 fw-medium"
                                                            style="background-color: #DC3545;">
                                                            Delete
                                                        </button>
                                                        <button type="button" class="btn btn-secondary fs-5 fw-medium"
    ...
    {{-- Modal | Add citizen --}}
    <div class="modal fade" id="addCitizenModal" tabindex="-1" aria-labelledby="addCitizenModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-2">
                            <div class="col col-4">
                                ...
                                <input type="text" name="hholdId" class="form-control" hidden
                                    value="{{ $house->id }}">
                            </div>
                            <div class="col col-3">
                                <label for="mname">
                            ...
                            <div class="col col-2">
                                ...
                                <input type="text" name="suff" id="suff" class="form-control"
                                    list="suffixOptions">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col col-2">
                                ...
                                <input type="text" name="frole" id="frole" class="form-control"
                                    list="frolelist" required>
                        ...
                        <div class="row mt-2">
                            <div class="col col-2">
                                <label for="yrsOfResidency">
                                    <h5>Yrs. of Residency</h5>
                                </label>
                                <input type="text" name="yrsOfResidency" id="yrsOfResidency" class="form-control"
                                    required>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col col-4">
                                <label for="citStatus">
                                    <h5>Citizen Status:</h5>
                                </label>
                                <input type="text" name="citStatus" id="citStatus" class="form-control"
                                    list="citStatusList">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-6">
                                ...
                                <input type="text" name="householdType" class="form-control" list="datalistOptions"
                                    value="{{ $house->household_type }}">
                            ...
                            <div class="col col-12">
                                ...
                                <select name="address" id="address" class="form-select" onchange="getId()">
                                    <option
                                        value="{{ $house->municipality_id }},{{ $house->barangay_id }}:{{ $house->subdivision_id }}">
                                        {{ $house->HholdToMun->mun_name }} - {{ $house->HholdToBrgy->brgy_name }} -
                                        {{ $house->HholdToSubd->subd_name }}</option>
                                    @foreach ($address as $addressRow)
                                        <option
                                            value="{{ $addressRow->mun_id }},{{ $addressRow->brgy_id }}:{{ $addressRow->subd_id }}">
                                            {{ $addressRow->mun_name }} - {{ $addressRow->brgy_name }} -
                                            {{ $addressRow->subd_name }}</option>
                                    @endforeach
                                </select>
                                <input type="text" name="mun_id" id="mun_id" class="form-control"
                                    value="{{ $house->municipality_id }}" hidden>
                                <input type="text" name="brgy_id" id="brgy_id" class="form-control"
                                    value="{{ $house->barangay_id }}" hidden>
                                <input type="text" name="subd_id" id="subd_id" class="form-control"
                                    value="{{ $house->subdivision_id }}" hidden>
                            </div>
